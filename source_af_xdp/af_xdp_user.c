...
static const char prog_name[] = "af_xdp_user\n";
...
static struct argp_option options[] = {
	...
	{"copy", 'C', 0, 0, "Force copy mode"},
	{"zero-copy", 'Z', 0, 0, "Force zero-copy mode"},
	{"queue", 'Q', 0, 0, "Configure interface receive queue for AF_XDP, default=0"},
	{"poll-mode", 'P', 0, 0, "Use poll() api for packets"},
...
int main(int argc, char **argv)
{
	...
	xdp_link_detach(cfg.ifindex, cfg.xdp_flags, 0, verbose);
